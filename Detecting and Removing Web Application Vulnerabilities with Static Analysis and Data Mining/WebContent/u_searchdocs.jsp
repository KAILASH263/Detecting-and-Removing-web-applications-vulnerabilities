    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <form action="u_searchresults.jsp" method="post">
		    <p>&nbsp;	        </p>
		<tr>
				<td width="227"><span class="style9">Enter Search Keyword : </span></td>
				<td width="225"><input name="key" type="text"  /></td>
		</tr>
		<tr>
			<td></td>
     ...
     <div align="right">
       <p><a href="u_skverify.jsp">Back</a></p>
     </div>
      </div>
