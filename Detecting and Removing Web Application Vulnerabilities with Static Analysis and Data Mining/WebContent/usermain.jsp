    ...
    <div class="content_resize">
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li><a href="usermain.jsp">Home</a></li>
            <li><a href="u_myprofile.jsp">View Profile</a> </li>
            <li><a href="u_skrequest.jsp">Send Secret Key Request</a> </li>
            <li><a href="u_skresponse.jsp">View Secret Key Response</a> </li>
            <li><a href="u_skverify.jsp">Search and Download Document </a></li>
            <li><a href="userlogin.jsp">Logout</a></li>
          </ul>
        </div>
