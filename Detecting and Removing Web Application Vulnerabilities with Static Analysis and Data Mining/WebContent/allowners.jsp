...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>All Owners List </span></h2>
          <p>&nbsp;</p>
          <p align="justify">
		...
		s3=rs.getString(11);
          ...
          <tr>
            ...
            <%
						...
						%>
            <td  width="73" height="56" align="center" valign="middle"><a href="conformuser.jsp?mid=<%=i%>&utype=<%="owner"%>">waiting&nbsp;</a></td>
            <%
						}
						else
						{ 
            ...
            <%
						...
						%>
            <td  width="63" valign="middle" height="56" style="color:#000000;"align="center"><a href="a_ownerdetails.jsp?mid=<%=i%>">more info..&nbsp;</a></td>
          </tr>
          <%
						}
						connection.close();
