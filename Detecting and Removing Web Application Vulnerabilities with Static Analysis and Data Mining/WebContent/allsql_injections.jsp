...
<head>
<title>all sql injected owners list</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>All SQL Injected Owners </span></h2>
          <p>&nbsp;</p>
          <p align="justify">
...
try 
{
	String query="select distinct username,action from sql_injection"; 
	...
	while( rs.next() )
	{
		...
		String sql1="select id,username from owner where username='"+s1+"'";
		...
		if(m==0){
            ...
            <td  width="103" height="37" align="center" valign="middle" style="color: #2c83b0;"><div align="center" class="style3 style9"><strong>View SQL Operation </strong></div></td>
			...
			<%}m=1;%>
			<form action="a_blockowner.jsp?oname=<%=s1%>" method="post">
          <tr>
			...
			<td  width="103" height="82" align="center" valign="middle"><a href="a_viewsqloperations.jsp?oname=<%=s1%>">View SQL Injected Operations</a></td>
			<%if(s2.equalsIgnoreCase("Block")){%>
			 <td  width="152" height="82" align="center" valign="middle"><input type="submit" value="<%=s2%>"  /></td>
			 <%}else{%>
			 <td  width="152" height="82" align="center" valign="middle"><span class="style5"> <%=s2%></span></td>
			 <%}%>
			</tr>	</form>
          <%
