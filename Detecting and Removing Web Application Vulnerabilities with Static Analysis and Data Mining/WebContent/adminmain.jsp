      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="allowners.jsp">View All Owners </a></li>
            <li><a href="alldocuments.jsp">View All Documents</a> </li>
            <li><a href="allattackers.jsp">View All Attackers</a></li>
            <li><a href="allsql_injections.jsp">View SQL Injected Owners</a>  </li>
            <li><a href="allblockedowners.jsp">View All Blocked Owners</a> </li>
            <li><a href="allunblockreq.jsp">View All Owners Unblock Requests</a></li>
            <li><a href="allusers_unblockreq.jsp">View All Users Unblock Requests</a> </li>
            <li><a href="allskrequests.jsp">View All Secret Key Requests</a></li>
            <li><a href="alldownloads.jsp">View All Downloads</a> </li>
            <li><a href="a_sqlinjectionchart.jsp">View SQL Injection Chart</a> </li>
            <li><a href="a_attackerschart.jsp">View Remote Vulnerabilities Chart</a></li>
            <li><a href="adminlogin.jsp">Logout</a></li>
          </ul>
        </div>
