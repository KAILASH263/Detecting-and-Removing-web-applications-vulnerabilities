...
<head>
<title>owners profile details</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Owner Profile Details  </span></h2>
          <p>&nbsp;</p>
          <p align="justify">
...
<%@ page import="org.bouncycastle.util.encoders.Base64"%>
				 ...
				 <input  name="image" type="image" src="profile_pic.jsp?id=<%=i%>&type=<%="owner"%>" style="width:170px; height:200px;"/></div></td>
					</tr>
...
<td  width="197" align="left" valign="middle" height="39"><div align="left" class="style11" style="margin-left:20px;"><%out.println(s4);%></div></td>
     ...
     <div align="right">
       ...
       <p>&nbsp;</p>
       <p>&nbsp;</p>
       <p><a href="allowners.jsp">Back</a></p>
     </div>
      </div>
