...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>All Users Secret Key Requests </span></h2>
          <p>&nbsp;</p>
          <p align="justify">
...
try 
{
	String query="select * from sk_request"; 
	...
	while( rs.next() )
	{
		...
		if(m==0){
            ...
            <td   width="152" height="37" align="center" valign="middle" style="color: #2c83b0;"><div align="center" class="style3 style9"><strong>Date On Requested</strong></div></td>
          </tr>
			<%}m=1;%>
          <tr>
			...
			<%
			if(s2.equalsIgnoreCase("Generate Secret Key"))
			{
			%>
			<td  width="103" height="82" align="center" valign="middle"><a href="generate_sk.jsp?id=<%=j%>">
			  <%out.println(s2);%></a></td>
			<%}
			else
			{
			%>
			 <td  width="152" height="82" align="center" valign="middle"><%out.println(s2);%></td>
			<%
			}%>
            <td  width="105" height="82" align="center" valign="middle"><%out.println(s3);%></td>
		</tr>	
          <%
						}
					}
